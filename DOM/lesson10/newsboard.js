...
const nextMessage = () => showMessageForEvent(currentMessageNumber += 1)
const prevMessage = () => showMessageForEvent(currentMessageNumber -= 1)
const firstMessage = () => showMessageForEvent(currentMessageNumber = 1)
const lastMessage = () => showMessageForEvent((currentMessageNumber = messages.length))

const showMessageForEvent = (targetMessageNumber) => {
